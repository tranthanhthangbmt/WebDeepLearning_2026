...
Dựa trên yêu cầu, hệ thống bài tập trắc nghiệm Chương 11 ("Phân đoạn hình ảnh") sẽ được xây dựng gồm tối thiểu 30 câu hỏi. Toàn bộ nội dung kiến thức để soạn câu hỏi sẽ được trích xuất **chính xác và trực tiếp** từ tài liệu Tiếng Việt của Chương 11 như sau:

## Nguồn tài liệu tham khảo chính
1. **Nội dung lý thuyết Tiếng Việt:** `Chapters/chapter_11.md` (Tab "Tiếng Việt")

## Phạm vi kiến thức bao phủ (từ nguồn trên)
1. **Nhiệm vụ thị giác máy tính**
2. **Đào tạo mô hình phân đoạn từ đầu**
3. **Sử dụng mô hình phân đoạn được huấn luyện trước**
4. **Bản tóm tắt**

## Proposed Changes

Tôi sẽ tạo một trang HTML chứa tối thiểu 30 câu hỏi trắc nghiệm và nhúng nó vào file `Chapters/chapter_11.md`.
...
- Mở và cập nhật file `Chapters/chapter_11.md`.
- Tải lại trang web chính trên trình duyệt tại đường dẫn `/#/Chapters/chapter_11` và chuyển sang tab **Bài tập Trắc nghiệm**.
