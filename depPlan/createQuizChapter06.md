...
Dựa trên yêu cầu, hệ thống bài tập trắc nghiệm Chương 6 ("Quy trình làm việc phổ biến của học máy") sẽ được xây dựng gồm tối thiểu 30 câu hỏi. Toàn bộ nội dung kiến thức để soạn câu hỏi sẽ được trích xuất **chính xác và trực tiếp** từ tài liệu Tiếng Việt của Chương 6 như sau:

## Nguồn tài liệu tham khảo chính
1. **Nội dung lý thuyết Tiếng Việt:** `Chapters/chapter_06.md` (Tab "Tiếng Việt")
...
Tôi sẽ tạo một trang HTML chứa tối thiểu 30 câu hỏi trắc nghiệm và nhúng nó vào file `Chapters/chapter_06.md`.
...
- Mở và cập nhật file `Chapters/chapter_06.md`.
- Tải lại trang web chính trên trình duyệt tại đường dẫn `/#/Chapters/chapter_06` và chuyển sang tab **Bài tập Trắc nghiệm**.
