# Kế hoạch Cập nhật Website: Nút Chuyển đổi Ngôn ngữ Thực hành (VN / EN) - Môn Học Sâu (Deep Learning)

Nhiệm vụ này yêu cầu cập nhật các trang markdown (ví dụ: `chuong_01.md` đến các chương tiếp theo) và file cấu hình chính (`index.html`) để thêm tính năng chuyển đổi ngôn ngữ linh hoạt cho các Jupyter Notebook thực hành.
...
> Các liên kết trong nút "Mở trên Google Colab" sẽ được tạo tự động dựa trên cấu trúc đường dẫn repo Github của bạn (`tranthanhthangbmt/WebDeepLearning_2026/blob/main/TaiLieu/NotebookJupyter/...`).
