...
Dựa trên yêu cầu, hệ thống bài tập trắc nghiệm Chương 2 ("Các khối xây dựng toán học của mạng lưới thần kinh") sẽ được xây dựng gồm tối thiểu 30 câu hỏi. Toàn bộ nội dung kiến thức để soạn câu hỏi sẽ được trích xuất **chính xác và trực tiếp** từ tài liệu Tiếng Việt của Chương 2 như sau:

## Nguồn tài liệu tham khảo chính
1. **Nội dung lý thuyết Tiếng Việt:** `Chapters/chapter_02.md` (Tab "Tiếng Việt")

## Phạm vi kiến thức bao phủ (từ nguồn trên)
1. **Cái nhìn đầu tiên về mạng lưới thần kinh**
2. **Biểu diễn dữ liệu cho mạng lưới thần kinh**
3. **Các bánh răng của mạng lưới thần kinh: Hoạt động của tensor**
4. **Công cụ của mạng lưới thần kinh: Tối ưu hóa dựa trên độ dốc**
5. **Nhìn lại ví dụ đầu tiên của chúng tôi**
6. **Bản tóm tắt**

## Proposed Changes

Tôi sẽ tạo một trang HTML chứa tối thiểu 30 câu hỏi trắc nghiệm và nhúng nó vào file `Chapters/chapter_02.md`.
...
3. **Giữ nguyên kiến thức trong Giải thích:** Phần nội dung dài dòng bị cắt đi khỏi đáp án đúng phải được di chuyển toàn bộ xuống phần **Giải thích (Explanation)**.

### Cập nhật File Markdown
#### [MODIFY] `Chapters/chapter_02.md`
...
- Mở và cập nhật file `Chapters/chapter_02.md`.
- Tải lại trang web chính trên trình duyệt tại đường dẫn `/#/Chapters/chapter_02` và chuyển sang tab **Bài tập Trắc nghiệm**.
